...
% plo
          hold on
plot3(time_array,feval(fit1x,time_array),feval(t1y_t,time_array),'r','LineWidth',2)
plot3(time_array,feval(fit1x,time_array),feval(t2y_t,time_array),'g','LineWidth',2)
plot3(time_array,feval(fit1x,time_array),feval(t3y_t,time_array),'b','LineWidth',2)
            hold on
% labels
xlabel('Time (s)')
