...
%% Setup MOTA params
global n_gnd_truth_objects; global gnd_truth_fits;
...
tracklet_temp_IDs = ones(1,n_gnd_truth_objects)*-1; % set all to -1 initially
...
global FN_array; global gnd_truth_fits
...
plot3(t, feval(gnd_truth_fits{2*i-1},t), feval(gnd_truth_fits{2*i},t),'cx','Markersize',20,'LineWidth',1)
